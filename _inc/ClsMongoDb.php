 ...
 * 2：其它更高级的操作可通过 $this->getMongo() 得到原生的对象，更多API请自行查阅 Mongo PHP手册,
...
//$m=  MongoDb(['host'=>'192.168.0.22','port'=>27017,'cmd'=>'$']);
//print_r($m);
//$time1=  ExecTime();
// 连接 Mongo
//$mongo = new MongoDbs(array('host'=>'192.168.0.22','port'=>27017));
//print_r($mongo);
...
//
//// 向 user 集合(表)中插入文档(记录) //使用类 5000 数据0.1秒左右
//for($i=1; $i<=5000; $i++){
...
//    }  
    ...
    //
//使用原生预警 执行5000次平均略小于0.1秒 
//$time1=  ExecTime();
//$connection = new Mongo("mongodb://192.168.0.22:27017");
////print_r($connection->listDBs());列出所有数据库
//$db = $connection->bug->user;
//for($i=1; $i<=5000; $i++){
//$doc=array('id'=>$i, 'name'=>'yuan'.$i);
//$db->insert($doc);
//}
//$time2=  ExecTime();
//echo $time2-$time1;
