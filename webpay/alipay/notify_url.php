...
if ($verify_result) {//验证成功
    ...
    if (!empty($doc->getElementsByTagName("notify")->item(0)->nodeValue)) {
        ...
        /* 从 out_trade_no 提取出订单id */
        $a_out_trade_no = explode('_', $out_trade_no);
        $orderid = $a_out_trade_no[1]; //订单id

        if ($trade_status == 'TRADE_SUCCESS') {//$trade_status == 'TRADE_FINISHED' OR 
            ...
            updateorder($orderid, $trade_no, $total_fee * 100);
