...
//②、统一下单
    ...
    $input->SetNotify_url("http://www.ejshendeng.com/webpay/wx/testnotify.php");
...
function virtualpay() {
    ...
    <html>
        ...
        <body>
            <br/>
            <font class="rental">该笔订单支付金额为<span class="red" style="font-size: 3rem;">0.01</span>元</font>
            <div id="info" class="red rental">正在打开微信支付</div>
        </body>
    </html>
