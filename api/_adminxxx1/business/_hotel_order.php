...
class myapi extends cls_api {
    ...
    function mylist() {
        ...
        $sql = 'select o.*,com.ic as comic,os.uid_send ,os.uname_send ,os.uid_accept ,os.uname_accept ,os.time_send ,os.time_accept,os.type_send from `' . sh . '_order` as o ';
        $sql .= ' left join `' . sh . '_ordergoods` as g on g.orderid=o.id ';
        $sql .= ' left join `' . sh . '_com` as com on o.comid=com.id ';
        $sql .= ' left join `' . sh . '_order_send` as os on o.id=os.orderid ';
        $sql .= ' where 1 ';
