...
class myclass extends cls_template{
	...
	require_once AdminApiPath . '_login.php'; //访问接口去
    ...
    function mainframe(){
		?>
			...
			<title>管理员登录</title>
			<link type="text/css" rel="stylesheet"  href="/_adminxxx1/css/base.css?t=1" />
			<link type="text/css" rel="stylesheet"  href="/_adminxxx1/css/main.css?t=1" />
			<link type="text/css" rel="stylesheet"  href="/_adminxxx1/css/plus.css?t=1" />
			<script src="/_js/jquery-1.11.3.min.js?t=1"></script>    
			<script src="/_js/main.js?t=1"></script>
			<script src="/_adminxxx1/js/main.js?t=1"></script>

			<script type="text/javascript">

				$(document).ready(function() { 
                                        document.getElementById("u_name").focus();//网页载入后光标自动定位到用户名输入框
					...
					$('#myform').bind('submit', function() {
						j_post($(this), function(json) {
							...
							if ('y' == json.success)
							{
								...
								mess['content'] = '<li><a href="index.php">二秒后自动进入管理中心.</a></li>';
