...
class myclass extends cls_template {
    ...
    function __construct() {
        parent::__construct();
        require_once (ApiPath . '/biz/business/_hotel_order.php'); //访问接口去
    ...
    function showlist(&$j) {
        ...
        <table class="table1 j_list" cellspacing="0">
            ...
            foreach ($j['list']['rs'] as $v) {
                ...
                echo '<td>';
                if (isset($v['time_accept'])) {
                    echo date("Y-m-d H:i:s", $v['time_send']);
                }
                echo '</td>' . PHP_EOL;
                echo '<td>';
                if (isset($v['time_accept'])) {
                    echo date("Y-m-d H:i:s", $v['time_accept']);
                }
                echo '</td>' . PHP_EOL;
