                    ...
                    <div class="sidebar">
                        ...
                        <ul>
                            <li><a href="/biz/business/history.php">补换货记录</a></li>
                              <li><a href="/biz/business/lack.php">缺货查询</a></li>
                            <li><a href="/biz/business/repair.php">神灯报警</a></li>
                            <li><a href="/biz/business/order.php">定单管理</a></li>
                            <li><a href="/biz/business/hotel_order.php">店内有售定单管理</a></li>
                            <li><a href="/biz/business/user.php">操作员管理</a></li>
                            <li><a href="/biz/business/place.php">铺位管理</a></li>
